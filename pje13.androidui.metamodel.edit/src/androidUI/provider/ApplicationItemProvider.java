...
/**
 * This is the item provider adapter for a {@link androidUI.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Application_applicationName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Application_applicationName_feature", "_UI_Application_type"),
				 AndroidUIPackage.Literals.APPLICATION__APPLICATION_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AndroidUIPackage.Literals.APPLICATION__PACKAGE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AndroidUIPackage.Literals.APPLICATION__PAGES);
		}
	...
	public String getText(Object object) {
		String label = ((Application)object).getApplicationName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AndroidUIPackage.Literals.APPLICATION__PAGES,
				 AndroidUIFactory.eINSTANCE.createPage()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return AndroidUIEditPlugin.INSTANCE;
	}
