...
/**
 * This is the item provider adapter for a {@link androidUI.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonItemProvider extends TextViewItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_onClick_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_onClick_feature", "_UI_Button_type"),
				 AndroidUIPackage.Literals.BUTTON__ON_CLICK,
				 true,
				 false,
				 true,
				 null,
