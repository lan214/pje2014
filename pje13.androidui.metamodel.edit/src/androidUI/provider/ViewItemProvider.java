...
/**
 * This is the item provider adapter for a {@link androidUI.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AndroidUIPackage.Literals.VIEW__ID,
				 true,
				 false,
				 false,
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_width_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_width_feature", "_UI_View_type"),
				 AndroidUIPackage.Literals.VIEW__WIDTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_height_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_height_feature", "_UI_View_type"),
				 AndroidUIPackage.Literals.VIEW__HEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
