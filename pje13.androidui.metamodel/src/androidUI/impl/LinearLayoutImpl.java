 ...
 * <ul>
 *   <li>{@link androidUI.impl.LinearLayoutImpl#getOrientation <em>Orientation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LinearLayoutImpl extends LayoutImpl implements LinearLayout {
	/**
	...
	protected EClass eStaticClass() {
		return AndroidUIPackage.Literals.LINEAR_LAYOUT;
	}
	...
	public void setOrientation(OrientationType newOrientation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AndroidUIPackage.LINEAR_LAYOUT__ORIENTATION, oldOrientation, orientation));
	}
